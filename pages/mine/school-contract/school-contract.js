...
Page({
  ...
  showConPage: function (e) {
    //  var index = e.currentTarget.dataset.id;
    wx.navigateTo({
      url: 'school-contract-show/school-contract-show?scc_id=' + e.currentTarget.dataset.sccid,
    })
  },
  // 合约评价
  ...
  getData: function () {
    var that = this;
    app.func.req('school_contract', { openid: that.data.openid, pageSize: 1000, page: 1 }, 'GET', function (res) {
